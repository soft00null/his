...
class Staff extends Admin_Controller {
    ...
    function create() {
        ...
        $this->form_validation->set_rules(
                'employee_id', $this->lang->line('staff') . " " . $this->lang->line('id'), array('required',
    ...
    function change_password($id) {
        ...
        $this->form_validation->set_rules('new_pass', $this->lang->line('new_message'), 'trim|required|xss_clean|matches[confirm_pass]');
