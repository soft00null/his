...
class Issueitem extends Admin_Controller {
    ...
    function add() {
        ...
        $this->form_validation->set_rules('issue_to', $this->lang->line('issue') . " " . $this->lang->line('to'), 'required|trim|xss_clean');
        $this->form_validation->set_rules('issue_by', $this->lang->line('issue') . " " . $this->lang->line('by'), 'required|trim|xss_clean');
