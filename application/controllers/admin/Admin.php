...
class Admin extends Admin_Controller {
    ...
    public function dashboard() {
        ...
        $parameter = array('opd' => $this->patient_model->getEarning('amount', 'opd_details', '', '', array('appointment_date >=' => date('Y-m-01'), 'appointment_date <=' => date('Y-m-t'))),
            ...
            'pharmacy' => $this->patient_model->getEarning('net_amount', 'pharmacy_bill_basic', 'customer_type', 'direct', $search),
        ...
        // echo $this->income_model->getTotal($search);
        //  echo $this->db->last_query();
        //     exit;
        ...
        foreach ($parameter as $key => $value) {
            ...
            if ($tot_data != 0) {
                $data[$key . "_data"] = ($value / $tot_data) * 100;
            } else {
                $data[$key . "_data"] = 0;
            }
