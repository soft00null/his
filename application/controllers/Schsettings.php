...
class Schsettings extends Admin_Controller {
    ...
    function ajax_schedit() {
        ...
        $this->form_validation->set_rules('opd_record_month', $this->lang->line('opd') . " " . $this->lang->line('record') . " " . $this->lang->line('month'), 'trim|required|xss_clean');
        ...
        if ($this->form_validation->run() == false) {
            $data = array(
                ...
                'opd_record_month' => form_error('opd_record_month'),
            );
            ...
            $data = array(
                ...
                'opd_record_month' => $this->input->post('opd_record_month'),
            );
            ...
            $this->session->userdata['admin']['credit_limit'] = $this->input->post('credit_limit');
            $this->session->userdata['admin']['opd_record_month'] = $this->input->post('opd_record_month');
