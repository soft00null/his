...
//=========
        ...
        if (!empty($chk_mail_sms)) {
            if (($send_for == "opd_patient_registration") || ($send_for == "ipd_patient_registration")) {
                ...
                if ($chk_mail_sms['mail']) {
                    $this->CI->mailgateway->sentDischargedMail($sender_details['patient_id']);
                }
                if ($chk_mail_sms['sms']) {
                    $this->CI->smsgateway->sentDischargedSMS($sender_details['patient_id']);
                }
