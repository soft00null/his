...
class Setting_model extends CI_Model {
    ...
    public function get($id = null) {
        ...
        $this->db->select('sch_settings.id,sch_settings.lang_id,sch_settings.class_teacher,sch_settings.mini_logo,sch_settings.is_rtl,sch_settings.cron_secret_key, sch_settings.timezone,
