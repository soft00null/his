                       ...
                       if ($this->module_lib->hasActive('tpa_management')) {
                        ...
                        if ($this->module_lib->hasActive('reports')) {
                                ...
                                <li class="treeview <?php echo set_Topmenu('Reports'); ?>">
                                    ...
                                    <ul class="treeview-menu">
                                      <li class="<?php echo set_Submenu('admin/income/transactionreport'); ?>"><a href="<?php echo base_url(); ?>admin/income/transactionreport"><i class="fas fa-angle-right"></i> <?php echo $this->lang->line('transaction_report'); ?></a></li>
                                    <?php 
                                    if ($this->module_lib->hasActive('OPD')) { 
