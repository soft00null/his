                ...
                <section class="sidebar" id="sibe-box">
                    <ul class="sidebar-menu verttop">
                        ...
                        <li class="treeview <?php echo set_Topmenu('profile'); ?>">
                            <?php if ($_SESSION['patient']['patient_type'] == "Outpatient") { ?>
                                <a href="<?php echo base_url(); ?>patient/dashboard/profile"><i class="fas fa-stethoscope"></i><span><?php echo $this->lang->line('opd'); ?></span>
                                </a>
                            <?php } else { ?>

                                <a href="<?php echo base_url(); ?>patient/dashboard/ipdprofile"><i class="fas fa-procedures" aria-hidden="true"></i><span><?php echo $this->lang->line('ipd'); ?></span>
                                </a>
                            <?php } ?>
                        </li>
