                ...
                <ul class="nav nav-tabs">
                  ...
                  <?php 
                    ...
                    foreach ($parameter as $ckey => $value) {
                     ...
                     ?>
                      <li class="<?php //if($j == 0){ echo "active" ;} ?>"><a href="#<?php echo $ckey ?>" data-toggle="tab" aria-expanded="true"><font style="text-transform: capitalize;"><?php echo $value["label"] ?></font></a></li>
                  <?php  }
                    $j++; } ?>
                                ...
                                if(!empty($result["amount"])){ 
                                 ...
                                 if(isset($result["reff"])){
                                  ...
                                  if(!($this->rbac->hasPrivilege('opd_patient', 'can_view') || $this->rbac->hasPrivilege('opd_report', 'can_view'))  && ($key1 == "OPD")) { 
                                      ...
                                      # code...
                                    }elseif (!($this->rbac->hasPrivilege('expense', 'can_view')) && ($key1 == "Expense")) {
                                      # code...
