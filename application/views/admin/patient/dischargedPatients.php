                                    ...
                                    if (empty($resultlist)) {
                                        ...
                                        foreach ($resultlist as $student) {
                                            ...
                                            <tr class="">
                                                ...
                                                <td><a href="<?php echo base_url(); ?>admin/patient/ipdprofile/<?php echo $student['id']; ?>/no"><?php echo $student['patient_name']; ?></a>
                                                    <div class="rowoptionview">       
                                                        <a href="<?php echo base_url(); ?>admin/patient/ipdprofile/<?php echo $student['id'] ?>/no" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('show'); ?>" >
