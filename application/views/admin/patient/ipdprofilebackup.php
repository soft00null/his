                ...
                <div class="nav-tabs-custom" id="tabs">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="consultant_register">
                            <!-- <div class="row">
                                <div class="col-md-12">
                             <a href="#" data-target="#add_diagnosis" data-toggle="modal" class="btn btn-info pull-right"><?php //echo $this->lang->line('add')   ?></a>
                                    </div>             
                                 </div>
                                 <br/> -->
                            <div class="table-responsive">
...
?> 
                        ...
                        <div class="tab-pane" id="timeline">
                            <!-- <div> 
                                <input type="button" data-target="#myTimelineModal" data-toggle='modal' class="btn btn-sm btn-primary pull-right " value="<?php //echo $this->lang->line('add')  ?>" /></div>
                            <br/> -->
