                                        ...
                                        <tr class="">
                                            <td>
                                                ...
                                                <div class="rowoptionview">
                                                    <?php if ($this->rbac->hasPrivilege('radiology test report', 'can_add')) { ?>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 paddlr">
                        <form id="formbatch" enctype="multipart/form-data" accept-charset="utf-8"  method="post" class="ptt10" >
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label><?php echo $this->lang->line('standard') . " " . $this->lang->line('charge'); ?><?php echo " (" . $currency_symbol . ')'; ?></label>

                                        <input type="text" readonly id="charge_html" class="form-control">
                                    </div>
                                </div> 
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label><?php echo $this->lang->line('applied') . " " . $this->lang->line('charge'); ?><?php echo " (" . $currency_symbol . ')'; ?></label>
