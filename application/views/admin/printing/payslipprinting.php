            ...
            <div class="col-md-10">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('payslip') . " " . $this->lang->line('header') . " " . $this->lang->line('footer'); ?></h3>
                    ...
                    <div class="box-body">
                        <div class="download_label"><?php echo $this->lang->line('payslip') . " " . $this->lang->line('header') . " " . $this->lang->line('footer'); ?></div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 paddlr"   id="edit_bedtypedata">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input  name="setting_for" placeholder="" value="payslip" type="hidden" class="form-control"   />
                                    <span class="text-danger name"></span>
                                </div>
                            </div>
