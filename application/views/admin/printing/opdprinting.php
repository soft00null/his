                    ...
                    <div class="box-header with-border">
                        ...
                        <?php if (empty($printing_list)) { ?>
                            <div class="box-tools pull-right">
                                <?php if ($this->rbac->hasPrivilege('opd_prescription_print_header_footer', 'can_add')) { ?>
                                        ...
                                        foreach ($printing_list as $key => $value) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-date pull-right">
                                                    <?php if ($this->rbac->hasPrivilege('opd_prescription_print_header_footer', 'can_edit')) { ?>
                                                    ...
                                                    <?php } ?>
                                                    <?php if ($this->rbac->hasPrivilege('opd_prescription_print_header_footer', 'can_delete')) { ?>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 paddlr"   id="edit_bedtypedata">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input  name="setting_for" placeholder="" value="opd" type="hidden" class="form-control"   />
                                    <span class="text-danger name"></span>
                                </div>
                            </div>
