            ...
            <div class="col-md-10">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('ipd') . " " . $this->lang->line('header') . " " . $this->lang->line('footer'); ?></h3>
                        <?php
                        if (empty($printing_list)) {
                            ?>
                            <div class="box-tools pull-right">
                                <?php if ($this->rbac->hasPrivilege('ipd_prescription_print_header_footer', 'can_add')) { ?>
                    ...
                    <div class="box-body">
                        <div class="download_label"><?php echo $this->lang->line('ipd') . " " . $this->lang->line('header') . " " . $this->lang->line('footer'); ?></div>
                                        ...
                                        foreach ($printing_list as $key => $value) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-date pull-right">
                                                    <?php if ($this->rbac->hasPrivilege('ipd_prescription_print_header_footer', 'can_edit')) { ?>
                                                    ...
                                                    <?php } ?>
                                                    <?php if ($this->rbac->hasPrivilege('ipd_prescription_print_header_footer', 'can_delete')) { ?>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 paddlr"   id="edit_bedtypedata">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input  name="setting_for" placeholder="" value="ipd" type="hidden" class="form-control"   />
                                    <span class="text-danger name"></span>
                                </div>
                            </div>
