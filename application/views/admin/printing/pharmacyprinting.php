            ...
            <div class="col-md-10">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('pharmacy') . " " . $this->lang->line('header') . " " . $this->lang->line('footer'); ?></h3>
                        <?php if (empty($printing_list)) {
                            ?> 
                            <div class="box-tools pull-right">
                                <?php if ($this->rbac->hasPrivilege('pharmacy_bill_print_header_footer', 'can_add')) { ?>
                    ...
                    <div class="box-body">
                        <div class="download_label"><?php echo $this->lang->line('pharmacy') . " " . $this->lang->line('header') . " " . $this->lang->line('footer'); ?></div>
                                        ...
                                        foreach ($printing_list as $key => $value) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-date pull-right">
                                                    <?php if ($this->rbac->hasPrivilege('pharmacy_bill_print_header_footer', 'can_edit')) { ?>
                                                    ...
                                                    <?php } ?>
                                                    <?php if ($this->rbac->hasPrivilege('pharmacy_bill_print_header_footer', 'can_delete')) { ?>
        ...
        <div class="modal-content modal-media-content">
            ...
            <div class="modal-body pt0 pb0">
                <form id="addbed"   class="ptt10" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 paddlr"   id="edit_bedtypedata">
                            <div class="col-sm-12">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="print_footer" placeholder="" type="text" class="form-control editor"></textarea>
                                    <input  name="setting_for" placeholder="" value="pharmacy" type="hidden" class="form-control"   />
                                    <span class="text-danger name"></span>
                                </div>
                            </div>
    ...
    function getRecord(id) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $("#printid").val(id);
                $("#print_footer").text(data.print_footer);
