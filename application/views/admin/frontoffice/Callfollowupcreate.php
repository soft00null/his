            ...
            <div class="col-md-4">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php echo $this->lang->line('add_call'); ?></h3>
                    </div><!-- /.box-header -->
                    ...
                    <form id="form1" action="<?php echo site_url('admin/callfollowup/addcall') ?>"   method="post" >
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1"><?php echo $this->lang->line('response'); ?></label>
                            ...
                            <div class="form-group">
                                <label for="pwd"><?php echo $this->lang->line('mobile'); ?></label>  
                                <input type="text" class="form-control" value="<?php echo set_value('mobile'); ?>" name="mobile">
                                <span class="text-danger"><?php echo form_error('mobile'); ?></span>
                            </div>

                            <div class="form-group">
                                <label for="pwd"><?php echo $this->lang->line('follow_up_date'); ?></label>
                            ...
                            <div class="form-group">
                                <label for="email"><?php echo $this->lang->line('name'); ?></label> <input type="text" value="<?php echo set_value('name'); ?>" class="form-control" name="name">
                                <span class="text-danger"><?php echo form_error('name'); ?></span>
                            </div>
                            <div class="form-group">
                                <div class="form-group">
                                    <label for="pwd"><?php echo $this->lang->line('landline'); ?></label>     <input type="text" class="form-control" value="<?php echo set_value('landline'); ?>"  name="landline">
                            ...
                            <div class="form-group">
                                <label for="email"><?php echo $this->lang->line('date_of_call'); ?></label><input id="date_of_call" name="doc" placeholder="" type="text" class="form-control"  value="<?php echo set_value('doc'); ?>" readonly="readonly" />
            ...
            <div class="col-md-8">
                ...
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('call_list'); ?></h3>
                            ...
                            <table class="table table-hover table-striped table-bordered example">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo $this->lang->line('mobile'); ?>
                                        </th>
                                        <th><?php echo $this->lang->line('no_of_child'); ?>
                                        </th>
                                        <th><?php echo $this->lang->line('date_of_call'); ?></th>
                                        <th><?php echo $this->lang->line('follow_up_date'); ?>
                                        </th>
