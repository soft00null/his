    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                ...
                <h4 class="box-title"><?php echo $this->lang->line('add') . " " . $this->lang->line('appointment'); ?></h4> 
            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text"  name="patient_id" id="patient_id" onchange="getpatientDetails()" class="form-control">
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
...
<div class="modal fade" id="myModaledit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="box-title"><?php echo $this->lang->line('edit') . " " . $this->lang->line('appointment') . " " . $this->lang->line('information'); ?></h4> 
            </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 table-responsive">
                                <table class="table mb0 table-striped table-bordered examples">
                                    <tr>
                                        ...
                                        <td width="35%"><span id='patient_ids'></span></td>
                                        <th width="15%"><?php echo $this->lang->line('patient') . " " . $this->lang->line('name'); ?></th>
                                        <td width="35%"><span id="patient_names"></span>
                                        </td>
                                    </tr>
                                    <tr>
    ...
    function viewDetail(id) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $("#status").html(data.appointment_status);
