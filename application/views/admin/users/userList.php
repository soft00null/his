                                    ...
                                    if (!empty($patientList)) {
                                        ...
                                        foreach ($patientList as $patient) {
                                            ...
                                            if ($patient_type == "Outpatient") {
                                                $url = base_url() . 'admin/patient/profile/' . $patient["id"];
                                            } elseif ($patient_type == "Inpatient") {
                                                $url = base_url() . 'admin/patient/ipdprofile/' . $patient['id'] . "/" . $patient['is_active'];
                                            } elseif ($patient_type == "OT") {
                                                $url = base_url() . 'admin/operationtheatre/otsearch/' . $patient['id'];
                                            }
                                            ?>
                                            <tr>
                                                <td><?php echo $patient['patient_unique_id']; ?></td>
                                                <td>
                                                    <a href="<?php echo $url ?>" target="_blank"><?php echo $patient['patient_name']; ?></a>
