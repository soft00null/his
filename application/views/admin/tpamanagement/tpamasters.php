                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-right editviewdelete-icon">
                                                            <?php if ($this->rbac->hasPrivilege('tpa_charges', 'can_edit')) { ?>
                                                                <a   data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>" onclick="get_org_charge('<?php echo $orgvalue["id"] ?>', 'edit_org_mad')" ><i class="fa fa-pencil"></i>
                                                                </a> 
                                                    <?php } if ($this->rbac->hasPrivilege('tpa_charges', 'can_delete')) { ?>
                                                                <a onclick="delete_recordById('<?php echo base_url('admin/tpa/delete/' . $orgvalue["id"] . '/'); ?><?php echo $orgvalue["org_id"] ?>', '<?php echo $this->lang->line('delete_message'); ?>')" data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" ><i class="fa fa-trash"></i>
                                                                </a>
            <?php } ?>
                                                        </td>
                                                    </tr>
