            ...
            ?>">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php echo $this->lang->line('backup_history'); ?></h3>
    ...
    <?php echo $this->customlib->getCSRF(); ?>
                    ...
                    <div class="box box-warning">
                        <div class="box-header with-border">
                            ...
                            <div class="box-tools pull-right">   
                                <a class="btn btn-primary btn-sm btn-info" data-toggle="tooltip" title="<?php echo $this->lang->line('cron_secret_key') ?>" href="<?php echo base_url() . "admin/admin/addCronsecretkey/" . $settinglist[0]['id'] ?>"><?php
...
<script type="text/javascript">
    ...
    $('.formdelete').submit(function () {
        var c = confirm('<?php echo $this->lang->line('are_you_sure_wont_to_delete_backup'); ?>');
        return c;
    });
    $('.formrestore').submit(function () {
        var c = confirm('<?php echo $this->lang->line('are_you_sure_wont_to_restore_backup'); ?>');
        return c;
    });
