...
<?php } ?>
                    ...
                    <div class="box border0 clear">
                        ...
                        <div class="box-body table-responsive">
                            <div class="download_label"><?php echo $this->lang->line('pathology') . " " . $this->lang->line('report'); ?></div>
                                    ...
                                    if (empty($resultlist)) {
                                        ...
                                        foreach ($resultlist as $report) {
                                            ...
                                            ?>
                                                ...
                                                <!-- <td>
                                                    <a href="<?php echo base_url(); ?>admin/pathology/download/<?php echo $report['pathology_report']; ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('download'); ?>">
