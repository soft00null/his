                ...
                <div class="box box-primary" id="tachelist">
                    ...
                    <div class="box-body">
                        ...
                        <div class="table-responsive mailbox-messages">
                            <div class="download_label"><?php echo $this->lang->line('pathology') . " " . $this->lang->line('category') . " " . $this->lang->line('list'); ?></div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                ...
                                                if ($this->rbac->hasPrivilege('pathology_category', 'can_delete')) {
                                                    ?>
                                                    <a class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="delete_recordById('<?php echo base_url(); ?>admin/pathologycategory/delete/<?php echo $lab['id'] ?>', '<?php echo $this->lang->line('delete_message'); ?>')";>
    ...
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                ...
                <h4 class="box-title"> <?php echo $this->lang->line('add') . " " . $this->lang->line('pathology') . " " . $this->lang->line('category'); ?></h4> 
            </div>
