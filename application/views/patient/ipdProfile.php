                        ...
                        <table class="table table-striped mb0 font13">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="bozerotop"><?php echo $result['ipd_no']; ?>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <th class="bozerotop"><?php echo $this->lang->line('bed');
                                        ;
                                        ?></th>
                                    <td class="bozerotop"><?php echo $result['bedgroup_name'] . "-" . $result['floor_name'] . "-" . $result['bed_name'] ?>
                                    </td>
...
<?php //if ($result['status'] != 'paid') {   ?>
                                                    ...
                                                    <!-- <tr>
                                                        <th><?php echo $this->lang->line('gross') . " " . $this->lang->line('total'); ?></th>
                                                        <td class="text-right ipdbilltable"><input type="text" readonly id="gross_total" value="<?php echo $total ?>" name="gross_total" style="width: 30%; float: right" class="form-control"></td>
                                                    </tr> -->
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-right ipdbilltable fontbold20"><input type="hidden"   id="other_charge" value="<?php
                                                                                                              ...
                                                                                                              ?>" name="other_charge" style="width: 30%; float: right;" class="form-control">
                                                            <span><?php
                                                                if (!empty($result["other_charge"])) {
                                                                    echo $result["other_charge"];
                                                                } else {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-right ipdbilltable fontbold20"><input type="hidden"  name="tax" value="<?php
                                                                                                              ...
                                                                                                              ?>" id="tax" style="width: 30%;float: right" class="form-control">
                                                            <span><?php
                                                                if (!empty($result["tax"])) {
                                                                    echo $result["tax"];
                                                                } else {
                                            ...
                                            <a href="#" class="btn btn-info" onclick="print('<?php echo $result["id"] ?>', '<?php echo $result["id"] ?>')"><?php echo $this->lang->line('print') . " " . $this->lang->line('bill'); ?></a>
...
?>
                                       <tr>
                                           <td></td>
                                           <td></td>
                                           <td>Net Total : <?php echo $total ?><br/>
                                              Total Paid Amount : <?php echo $paid_amount ?><br/>
...
?>
    ...
    <?php } ?>
                                            ...
                                            <tr>
                                                <td colspan='4' class="text-right"><?php echo $this->lang->line('total') . " : " . $total; ?>
                                                </td>
                                            </tr>
<?php } ?>
                                    </table>
