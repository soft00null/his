...
<?php } ?>
                    ...
                    <table width="100%" class="printablea4">
                        <tr>
                            <td align="text-left"><h5><?php echo $this->lang->line('bill') . " " . $this->lang->line('number') . " : " ?><?php echo $result["ipdid"] ?></h5></td>
                    ...
                    <table class="printablea4" width="100%">
                        <tr>
                            ...
                            <th width="16%" class=""><?php echo $this->lang->line('payment') . " " . $this->lang->line('mode'); ?></th>
...
?></td>
                        ...
                        <tr>
                            <th width="20%"><?php echo $this->lang->line('net_payable') . " " . $this->lang->line('amount') . " (" . $currency_symbol . ")" ?></th> 
                            <td align="right"><?php
